...
namespace i5.Toolkit.Core.OpenIDConnectClient
{
    ...
    /// </summary>
    public class AzureAdOidcProvider : AbstractOidcProvider
    {
        /// <summary>
        ...
        /// </summary>
        public AzureAdOidcProvider(string tenantId) : base()
        {
            serverName = $"https://login.microsoftonline.com/{tenantId}/";
        ...
        public override async Task<string> GetAccessTokenFromCodeAsync(string code, string redirectUri)
        {
            ...
            Debug.Log("Token endpoint: " + tokenEndpoint);
            Debug.Log("form data: ");
            Debug.Log(form.data);
